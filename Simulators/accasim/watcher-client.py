...
import os
import argparse
from accasim.utils.misc import CONSTANT, load_config, SystemStatus as system_status
...
if __name__ == '__main__':
    CONFIG_FOLDER = '/home/er3/ORNL-Work/Simulators/accasim/config/'
    ESSENTIALS_FILENAME = '/home/er3/ORNL-Work/Simulators/accasim/config/essentials.config'
    const = CONSTANT()
